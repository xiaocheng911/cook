            ...
            <div>
                <div className={style.videoCla}>
                    <div className={style.middleCla}>
                        <NavLink exact activeClassName={style.Aactive} to={"/video"} onClick={() => {
                            this.setState({
                                claOpen: false
                            })
                        }}>
                        ...
                        </NavLink>
                        {
                            this.state.cla.map((v, i) => (
                                <NavLink activeClassName={style.Aactive} to={"/video/c" + i + "?" + v.categoryId} key={v.categoryId} onClick={() => {
                                    console.log(1111);
                                    this.setState({
                                        claOpen: true
                                    })
                ...
                <Carousel
                    className={this.state.claOpen ? style.hide : style.show}
                    autoplay={true}
                    infinite={true}
                >
